...
public class UpAmount implements BaseDao {
    ...
    public SearchSourceBuilder initTemple(DaoArgs args) {
        ...
        searchSourceBuilder.query(select).sort(SortBuilders.fieldSort("@timestamp").order(SortOrder.DESC))
                .fields(Arrays.asList( "userName","parentName","uuid","event","1015.rebate","1016.rebate",
                        "1015.commFeeRate","1015.rebateRate","1016.commFeeRate","1016.rebateRate",
                        "1015.amount","1015.commFee","1016.amount","1016.commFee","@timestamp"));;
