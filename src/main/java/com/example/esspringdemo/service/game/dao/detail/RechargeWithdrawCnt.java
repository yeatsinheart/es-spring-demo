...
/**
* 原始模板/detail/rechargeWithdrawCnt
**/
public class RechargeWithdrawCnt implements BaseDao {
    /**
     * 生成查询对象
...
//todo must
        ...
        select.minimumNumberShouldMatch(1).adjustPureNegative(true).boost(1).filter(QueryBuilders.termsQuery("event", Arrays.asList(1000, 1001)));
